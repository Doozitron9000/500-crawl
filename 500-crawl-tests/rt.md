signup with non-matching un and pw - fail
signup with matching un and pw - success
do the above but using the same un as above - fail
login with the username and pword from 2
start a new game
